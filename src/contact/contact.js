    ...
    <div>
      ...
      <div id="content">
        <div className="poppins">
          ...
          <p className="content-sub-heading">Get in touch today for us to have the opportunity to serve and support you in achieving your learning goals.</p>
          <form className="content-form" name="myForm">
            <div className="mw-100 d-flex">
              <div className="input-name">
                <div className="w-50">
                  <label className="label poppins">Your Name</label><br />
                  <input type="text" name="Name" className="input" /><br /><br />
                </div>
                <div className="w-50">
                  <label className="label poppins">Email</label><br />
                  <input type="text" name="Email" className="input" /><br /><br />
                </div>
              </div>
            </div>
            <label className="label poppins">Subject</label><br />
            <input type="text" name="Subject" className="input1" /><br /><br />
            <label className="label poppins">Message</label><br />
            <textarea cols="98.5" rows="3" name="Message" className="input3"></textarea><br /><br /><br />
